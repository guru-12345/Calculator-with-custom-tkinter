...
# Line 30 : Define a function to handle button clicks and update the result display
# Line 31 : Get the current text (value) from the result label
# Line 32 : If the current text is "0", replace it with the clicked value, 
#otherwise append the clicked value to the current text

# Line 60 : Set the command for each button to trigger the button_click 
